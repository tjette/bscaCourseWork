  ...
  var daveMatthews= {};
  //console.log(daveMatthews);

  daveMatthews.addBandmate = function addBandmate(name,instrument){
     this[name] = instrument;
  };

  daveMatthews.addBandmate("Dave","Vocals");
  daveMatthews.addBandmate("Timmy Reynolds","Guitar");

  console.log("My band:", daveMatthews);
  ...
  //(the name of the band member being removed).
    ...
    daveMatthews.removeBandmate = function removeBandmate(name){
        delete this[name];
    }
  //
  ...
  //below
    daveMatthews.removeBandmate("Timmy Reynolds");
  console.log("My band is now:", daveMatthews);
  ...
  //
    daveMatthews.bandPlay = function bandPlay(){
  var bandMembers = Object.keys(this);
  var band = this;
  console.log("My band members are:", bandMembers);
